...
const PageTabListItem = ({ path, label, office, prevPage, removeTab, idx, location, history }) => {

    const renderPrevPage = prevPage ? <div className="tab-list__item__prev-page">{prevPage}/</div> : null;
