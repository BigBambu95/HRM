...
const DocumentTableContainer = ({
  documentsSort, sort, documents, deleteDocument,
}) => {
...
const mapStateToProps = ({
  documentList: {
    documents, error, loading, documentsSort,
  },
}) => ({
  documents, documentsSort, error, loading,
});

const mapDispatchToProps = (dispatch, ownProps) => {
  const { hrmService } = ownProps;
  const {
    documentsRequest, documentsLoaded, documentsError, removeDocument, sortDocuments,
  } = documents;
