...
import { getWorkersSalary, getWorkersNames, getMonth,
    getWorkersHours, getWorkersIncomeTax,
    getWorkersPensionInsurance, getWorkersHealthInsurance,
    getWorkersSocialInsurance, getWorkersAccidentInsurance,
    getWorkersPrepayment, getWorkersOtherFees, getWorkersFinalSalary,
...
const SalaryTable = ({
 workersNames, workersHours, workersSalary, workersIncomeTax, workersPensionInsurance, workersHealthInsurance,
 workersSocialInsurance, workersAccidentInsurance, workersPrepayment, workersOtherFees, workersFinalSalary, workersTotalSalary,
    month
}) => {
    return(
        <Fragment>
            ...
            <footer className="salary__footer">
                <div className="salary__footer__total-sum">За {month} к выдаче: {workersTotalSalary} ₽</div>
                <Button size="medium" variant="solid" color="purple" font="large">Выдать</Button>
            </footer>
        </Fragment>
    )
};
