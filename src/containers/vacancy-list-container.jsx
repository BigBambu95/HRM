      ...
      >
        ...
        <div>
          ...
          <Grid columns={4} gap="1em">
            {
              vacancyTemplates.map((template, idx) => <Button key={idx} variant="outlined" size="large">{template}</Button>)
            }
          </Grid>
        </div>
...
const mapDispatchToProps = (dispatch, ownProps) => {
  ...
  const {
    vacanciesRequest, vacanciesLoaded, vacanciesError, removeVacancy, setFilterProfessionValue, setFilterOfficeValue,
  } = vacancies;
