...
const WorkerListContainer = ({        
  ...
  setFilterOfficeValue, setFilterProfessionValue, 
  setFilterDepartmentValue, match, filterOffice,
  filterProfession, filterDepartment
}) => {
          ...
          <div className={clazz}>
              <ToolBar>
                  <FilterList>
                      <Filter 
                        label="Должность" 
                        items={workerProfessions.concat(filterProfession)} 
                        filter={setFilterProfessionValue} 
                        defaultValue={filterProfession} 
                      />
                      <Filter 
                        label="Офис" 
                        items={workerOffices.concat(filterOffice)}
                        filter={setFilterOfficeValue} 
                        defaultValue={filterOffice} 
                      />
                      <Filter 
                        label="Отдел" 
                        items={workerDepartments.concat(filterDepartment)} 
