...
function* watchfetchVacancy() {
	yield takeEvery(REQUEST(FETCH_VACANCY) as any, fetchVacancy)
}
...
function* watchAddVacancy() {
	yield takeEvery(REQUEST(ADD_VACANCY) as any, addVacancy)
}
...
function* watchRemoveVacancy() {
	yield takeEvery(REQUEST(REMOVE_VACANCY) as any, removeVacancy)
}
